...
(round-robin
 (list (alpha-beta-searcher 2 #'mobility)
       (alpha-beta-searcher 2 #'count-difference)
       (alpha-beta-searcher 2 #'mix-count-mobility-3)
       (alpha-beta-searcher 2 #'matrix-solution-2-algorith)
       (alpha-beta-searcher 2 #'mobility-matrix-solution-2-algorith-2)
       #'random-strategy)
 100
 10
 '(mobility
   count-difference
   mix-count-mobility-3
   matrix-solution-2-algorith
